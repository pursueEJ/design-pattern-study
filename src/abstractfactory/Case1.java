...
/**
 * <p>The class Case1 was created on 2022/4/13.</p>
 * <p>
 * TODO
 * </p>
 *
...
public class Case1 {
    ...
    interface ButtonFactory { Button factoryMethod(); }
    ...
    interface TextFieldFactory { TextField factoryMethod(); }
    ...
    interface ComboBoxFactory { ComboBox factoryMethod(); }
